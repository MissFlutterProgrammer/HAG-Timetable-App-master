...
void main() {
  test("Test drop out notification message", () {
    ...
    substitutionsBefore.setDay([
      {"Stunde": "3-4", "Raum": "C2.02"},
      {"Stunde": "1-2"}
    ], substDate, "before");
    final weekSubstitutions = WeekSubstitutions(null, "now");
    weekSubstitutions.setDay([
      {
        "Stunde": "3-4",
        "statt Fach": "en2",
        "Raum": "C2.02",
    ...
    withClock(Clock.fixed(substDate), () {
      final result = getSubstitutionsNotificationText(
          substitutionsBefore.toJson(), weekSubstitutions.toJson())!;
  ...
  test("Test subject change notification message", () {
    ...
    final weekSubstitutions = WeekSubstitutions(null, "now");
    weekSubstitutions.setDay([
      {"Stunde": "5-6", "statt Fach": "en2", "Fach": "ma5"},
      {"Stunde": "1-2"}
    ], substDate, "now");
    withClock(Clock.fixed(substDate), () {
      final result = getSubstitutionsNotificationText(
  ...
  test(
      "Test reverted subject change notification message, with unspecified original subject",
      () {
    final substitutionsBefore = WeekSubstitutions(null, "before");
    final substDate = DateTime.parse("2022-03-24");
    substitutionsBefore.setDay([
      {"Stunde": "5-6", "statt Fach": "---", "Fach": "ma5"},
      {"Stunde": "1-2"}
    ], substDate, "before");
    final weekSubstitutions = WeekSubstitutions(null, "now");
    weekSubstitutions.setDay([
  ...
  test("Test room change notification message", () {
    ...
    withClock(Clock.fixed(substDate.add(const Duration(days: 1))), () {
      ...
      expect(result.item2,
          "Morgen findet PO2 in C1.05, anstatt in Raum C2.02 statt");
    });
  });
  ...
  test("Test teacher change notification message", () {
    ...
    withClock(Clock.fixed(substDate.add(const Duration(days: 1))), () {
      ...
      expect(
          result.item2, "wn1 wird Morgen von Swz, anstatt von Sz unterrichtet");
    });
  });
  ...
  test("Test no notification message, when nothing changed", () {
    ...
    final substDate = DateTime.parse("2022-03-23");
    substitutionsBefore.setDay([
      {"Stunde": "1-2", "statt Fach": "PO1", "Raum": "C1.05", "Entfall": "x"},
      {"Stunde": "5-6", "statt Fach": "ek1", "Raum": "C1.03", "Entfall": "x"}
    ], substDate, "before");
    final weekSubstitutions = WeekSubstitutions(null, "now");
    weekSubstitutions.setDay([
      {"Stunde": "5-6", "statt Fach": "ek1", "Raum": "C1.03", "Entfall": "---"},
      {"Stunde": "1-2", "statt Fach": "PO1", "Raum": "C1.05", "Entfall": "x"}
    ], substDate, "now");
    withClock(Clock.fixed(substDate), () {
      final result = getSubstitutionsNotificationText(
  ...
  group("cleanupWeekSubstitutionJson", () {
    test("Test cleanupWeekSubstitutionJson", () {
      ...
      substitutions.setDay([
        ...
        getSubstitutionMap(
            ...
            originalSubject: "  D ",
            subject: "\t B  ",
            text: "I'm allowed to have spaces"),
        getSubstitutionMap(
            hour: "8-9", originalSubject: "\nE\n", originalTeacher: "  Go "),
      ...
      expect(
          const DeepCollectionEquality().equals(substitutionsJson, {
            "4": [
              [
                getSubstitutionMap(hour: "1", originalSubject: "A"),
                getSubstitutionMap(
                ...
                getSubstitutionMap(
                    ...
                    text: "I'm allowed to have spaces"),
                getSubstitutionMap(
                    hour: "8-9", originalSubject: "E", originalTeacher: "Go"),
                getSubstitutionMap(hour: "10-11", originalSubject: "\u{00A0}"),
              ],
              substDate.toString()
            ]
          ...
          true,
          reason: "Substitutions were not cleaned up sufficiently");
    });
    ...
    test("Test cleanupWeekSubstitutionJson check day removal mid week", () {
      ...
      substitutions.setDay(
          [getSubstitutionMap(hour: "1", originalSubject: "A")],
          DateTime.parse("2022-03-21"),
          "something");
      substitutions.setDay(
          [getSubstitutionMap(hour: "2", originalSubject: "A")],
          DateTime.parse("2022-03-25"),
          "something");
      substitutions.setDay(
          [getSubstitutionMap(hour: "3", originalSubject: "A")],
          DateTime.parse("2022-03-28"),
          "something");
      final substitutionsJson = substitutions.toJson();
      withClock(Clock.fixed(DateTime.parse("2022-03-23")),
          () => cleanupWeekSubstitutionJson(substitutionsJson, ["A"]));
      expect(
          const DeepCollectionEquality().equals(substitutionsJson, {
            "5": [
              [getSubstitutionMap(hour: "2", originalSubject: "A")],
              DateTime.parse("2022-03-25").toString()
            ]
          }),
          true);
    });
    ...
    test("Test cleanupWeekSubstitutionJson check day removal week start", () {
      ...
      substitutions.setDay(
          ...
          "something");
      final substitutionsJson = substitutions.toJson();
      withClock(Clock.fixed(DateTime.parse("2022-03-21")),
          () => cleanupWeekSubstitutionJson(substitutionsJson, ["A"]));
      expect(
          const DeepCollectionEquality().equals(substitutionsJson, {
            "1": [
              [getSubstitutionMap(hour: "2", originalSubject: "A")],
              DateTime.parse("2022-03-21").toString()
            ],
            "5": [
              [getSubstitutionMap(hour: "3", originalSubject: "A")],
              DateTime.parse("2022-03-25").toString()
    ...
    test("Test cleanupWeekSubstitutionJson check day removal next week", () {
      ...
      substitutions.setDay(
          ...
          "something");
      final substitutionsJson = substitutions.toJson();
      withClock(Clock.fixed(DateTime.parse("2022-03-26")),
          () => cleanupWeekSubstitutionJson(substitutionsJson, ["A"]));
      expect(
          const DeepCollectionEquality().equals(substitutionsJson, {
            "1": [
              [getSubstitutionMap(hour: "3", originalSubject: "A")],
              DateTime.parse("2022-03-28").toString()
            ]
          }),
          true);
    });
    ...
    test("Test cleanupWeekSubstitutionJson day boundary", () {
      final substitutions = WeekSubstitutions(null, "before");
      substitutions.setDay(
          [getSubstitutionMap(hour: "5-6", originalSubject: "PO")],
          DateTime.parse("2022-09-15"),
          "something");
      final substitutionsJson = substitutions.toJson();
      withClock(Clock.fixed(DateTime.parse("2022-09-17 00:11:53")),
          () => cleanupWeekSubstitutionJson(substitutionsJson, ["PO"]));
      expect(
          const DeepCollectionEquality().equals(substitutionsJson, {}), true);
    });
  });
}
